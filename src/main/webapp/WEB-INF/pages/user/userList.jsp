...
<head>
  ...
  <!--dynamic table-->
  <link href="${pageContext.request.contextPath}/js/advanced-datatable/css/demo_page.css" rel="stylesheet" />
  <link href="${pageContext.request.contextPath}/js/advanced-datatable/css/demo_table.css" rel="stylesheet" />
...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="logo-icon text-center">
            <a href="index.html"><img src="${pageContext.request.contextPath}/images/logo_icon.png" alt=""></a>
        </div>
        ...
        <div class="left-side-inner">
            ...
            <div class="visible-xs hidden-sm hidden-md hidden-lg">
                <div class="media logged-user">
                    <img alt="" src="${pageContext.request.contextPath}/images/photos/user-avatar.png" class="media-object">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list nav-active"><a href="#"><i class="fa fa-th-list"></i> <span>Data Tables</span></a>
                    <ul class="sub-menu-list">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/user/userList"> Advanced Table</a></li>
...
<!--dynamic table-->
<script type="text/javascript" language="javascript" src="${pageContext.request.contextPath}/js/advanced-datatable/js/jquery.dataTables.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/data-tables/DT_bootstrap.js"></script>
